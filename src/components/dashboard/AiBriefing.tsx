    ...
    <Card className="bg-card border-[hsl(var(--status-ai)/0.15)] relative overflow-hidden h-full">
      ...
      <CardHeader className="pb-2 pt-4 px-5 relative z-10">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs text-[hsl(var(--status-ai)/0.5)] font-mono ml-auto">10:00</span>
        </div>
      </CardHeader>
      <CardContent className="px-5 pb-4 relative z-10 space-y-3">
        ...
        <div className="text-sm text-foreground/70 leading-relaxed space-y-1">
          <p className="text-[hsl(var(--status-ai))] font-medium text-xs uppercase tracking-wider">Рекомендации</p>
          <div className="flex items-start gap-1.5">
            <span className="text-[hsl(var(--status-ai))] mt-px text-xs">→</span>
            <span>Перераспределить бюджет «Avicenna»</span>
          </div>
          <div className="flex items-start gap-1.5">
            <span className="text-[hsl(var(--status-critical))] mt-px text-xs">→</span>
            <span>Решить карту в «Технология позвоночника»</span>
          </div>
          <div className="flex items-start gap-1.5">
            <span className="text-[hsl(var(--status-warning))] mt-px text-xs">→</span>
            <span>Обновить креативы «Дентал Тайм»</span>
          </div>
        </div>
        <Button
          size="sm"
          className="w-full bg-[hsl(var(--status-ai))] hover:bg-[hsl(25_95%_46%)] text-white border-0 h-8 text-xs font-medium"
        >
