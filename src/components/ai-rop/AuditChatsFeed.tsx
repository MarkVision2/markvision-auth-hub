    ...
    <>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <MessageCircle className="h-4 w-4 text-[hsl(var(--status-good))]" />
          <span className="text-sm font-medium text-foreground">Всего чатов: {chats.length}</span>
        </div>
        ...
        <Table>
          <TableHeader>
            <TableRow className="border-border hover:bg-transparent">
              ...
              <TableHead className="text-[11px] text-muted-foreground font-medium uppercase tracking-wider">Канал</TableHead>
              <TableHead className="text-[11px] text-muted-foreground font-medium uppercase tracking-wider">Сообщений</TableHead>
