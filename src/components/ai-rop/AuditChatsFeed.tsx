...
import { MessageCircle, Bot, Eye, Inbox, CheckCircle2, MessageSquare } from "lucide-react";
  ...
  if (chats.length === 0) {
    return (
      <div className="rounded-xl border border-border bg-card flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-xs text-muted-foreground mt-1">Данные появятся после загрузки переписок</p>
      </div>
    );
  }
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="hidden lg:flex items-center gap-2 shrink-0">
                  <div className="flex items-center gap-1 px-2 py-1 rounded-lg bg-[hsl(var(--status-good)/0.06)] text-[11px] text-[hsl(var(--status-good))]">
