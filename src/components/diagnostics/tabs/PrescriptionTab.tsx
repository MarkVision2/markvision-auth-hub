...
export const PrescriptionTab: React.FC<Props> = ({ lead, doctorData, data, onChange }) => {
    ...
    const [formData, setFormData] = useState<PrescriptionFormData>(data || {
        selectedZones: [],
        packageId: "",
        startDate: new Date().toISOString().split('T')[0],
        doctorName: lead.doctor_name || "Иванов И.И.",
        schedule: [
    ...
    return (
        <div className="flex flex-col space-y-8 animate-in fade-in pb-10 max-w-5xl mx-auto w-full">
            ...
            <div className="bg-primary/5 p-6 rounded-3xl border border-primary/20 flex items-start justify-between">
                <div>
                    <h2 className="text-xl font-black uppercase tracking-tight text-primary flex items-center gap-2 mb-2">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                <div className="xl:col-span-1 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        />
                        <p className="text-xs text-muted-foreground italic text-center">Нажмите на зоны, на которые будет направлено лечение</p>
                    </div>
                            ...
                            {PACKAGES.map(pkg => (
                                ...
                                >
                                    ...
                                    <div className="flex justify-between items-center text-xs text-muted-foreground mt-2">
                                        ...
                                        <span className="font-black text-foreground">{pkg.price}</span>
                                    </div>
                                </div>
                            ))}
                        </div>
                ...
                <div className="xl:col-span-2 space-y-6">
                    ...
                    <div className="flex items-center gap-4 bg-secondary/10 p-4 rounded-2xl border border-secondary/20">
                        <div className="flex-1 space-y-2">
                            <Label className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Старт курса</Label>
                        ...
                        <div className="flex-1 space-y-2">
                            <Label className="text-xs font-bold text-muted-foreground uppercase tracking-widest">Лечащий врач</Label>
                    ...
                    <div className="bg-card border border-border/60 rounded-3xl overflow-hidden shadow-sm">
                        ...
                        <div className="p-2 border-t border-border/50 bg-secondary/5">
                            <Button variant="ghost" size="sm" onClick={addScheduleRow} className="w-full h-8 text-xs font-bold text-muted-foreground hover:text-foreground border border-dashed border-border hover:border-border/80">
            ...
            <div className="flex justify-end pt-4 mt-8 border-t border-border">
                ...
                <p className="text-xs text-muted-foreground mr-6 self-center italic">Не забудьте сохранить изменения перед генерацией PDF листа</p>
                <div className="px-6 py-3 rounded-xl bg-secondary/30 text-sm font-bold flex items-center gap-2 border border-secondary">
