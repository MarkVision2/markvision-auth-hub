...
const insights = [
  ...
  { icon: <Ban className="h-3.5 w-3.5 text-destructive" />, text: "Отключено 3 убыточных кампании → сэкономлено 45 000 ₸." },
...
export default function HqAiDirector() {
  return (
    <div className="relative rounded-2xl border border-border bg-card p-5 h-full overflow-hidden">
      {/* Subtle radial glows */}
      <div className="absolute -top-16 -right-16 h-40 w-40 rounded-full bg-[hsl(var(--status-ai))] opacity-[0.04] blur-3xl" />
      <div className="absolute -bottom-12 -left-12 h-32 w-32 rounded-full bg-primary opacity-[0.03] blur-3xl" />
